...
**Scaffolding mode (0.8.4).** Per the private evaluation harness:
...
- `evaluate_ship_gates()` reports per-gate pass/fail with human-readable reasons matching the `SHIP_GATES` table.
